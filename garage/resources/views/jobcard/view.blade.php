                            ...
                            <form method="post" action="{!! url('/jobcard/store') !!}" class="addJobcardForm">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                        ...
                                        <div class="row mt-3">
                                            <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">{{ trans('message.Contact No') }}:</label>
                                            <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 vehicle_space">
                                        ...
                                        @if (!empty($s_date))
                                        <div class="row mt-3 divId" id="divId">
                                            <label class="control-label col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2">{{ trans('message.Date Of Sale') }}:
                                            </label>
                                            <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                        ...
                                        <div class="row mt-3">
                                            <label class="col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2">{{ trans('message.Wash Bay Charge') }}<label class="text-danger"></label>:</label>
                                            <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-danger initiateProcessBtn border-0 text-light" disabled="true">{{ trans('message.Initiate Process') }}</button>
                                                        @endif

                                                        @if ($washbay_data->initiate_status == 1)
                                                        <button type="button" class="btn btn-success completeProcess" id="completeProcessBtn" url_complete_process="{{ url('/jobcard/complete_process_status') }}">
                                                        ...
                                                        <button type="button" class="btn btn-success completeProcess" disabled="true">
                                                            <span id="" class="completeProcessSpin glyphicon "></span>
                                                            {{ trans('message.Complete Process') }}</button>
                                                        &emsp;
