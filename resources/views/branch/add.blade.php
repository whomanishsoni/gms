		...
		<div class="page-title">
			<div class="nav_menu">
				<nav>
					...
					<a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup"><a href="{!! url('/branch/list') !!}" id=" "><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow"></i><span class="titleup"> {{ trans('message.Add Branch')}}</span></a>
					</div>
				...
				<div class="x_content">
					<form id="branchAddForm" method="post" action="{!! url('branch/store') !!}" enctype="multipart/form-data" class="form-horizontal branchAddForm">
						...
						<div class="row">
							...
							<div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 my-1 mx-0 pl-40 pr-15">
