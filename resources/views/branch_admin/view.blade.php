      ...
      <div class="nav_menu">
        <nav>
          <div class="nav toggle">
            <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup"><a href="{!! url('/branchadmin/list') !!}"><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="me-2 back-arrow"> {{ $branchadmin->name . ' ' . $branchadmin->lastname }}</span></a>
          </div>
    ...
    <div class="row">
      <div class="col-xl-10 col-md-9 col-sm-10">
        <div class="user_profile_header_left">
          <img class="user_view_profile_image" src="{{ URL::asset('public/branch_admin/' . $branchadmin->image) }}">
          <div class="row">
            <div class="view_top1">
              <div class="col-xl-12 col-md-12 col-sm-12">
                <label class="nav_text h5 user-name">
                  {{ $branchadmin->name . ' ' . $branchadmin->lastname }}&nbsp;
                </label>
                @can('branchAdmin_edit')
                <div class="view_user_edit_btn d-inline">
                  <a href="{!! url('/branchadmin/list/edit/' . $branchadmin->id) !!}">
              ...
              <div class="col-xl-12 col-md-12 col-sm-12 nav_text mt-2">
                <div class="d-lg-inline">
                  <i class=" fa fa-phone"></i> {{ $branchadmin->mobile_no }}
                </div>
                <div class="d-lg-inline">
                  <i class=" fa fa-envelope"></i> {{ $branchadmin->email }}
                </div>
              </div>
    ...
    <div class="panel-body padding_0 pb-0">
      ...
      <div class="row margin_top_15px mx-1">
        <div class="col-xl-3 col-md-3 col-sm-6">
          ...
          <label class="fw-bold">{{ $branchadmin->display_name  ?? $branchadmin->name }}<br></label>
        </div>
        <div class="col-xl-3 col-md-3 col-sm-6">
          <label class="">{{ trans('message.Date of Birth') }} </label><br>
          <label class="fw-bold">
            @if (!empty($branchadmin->birth_date))
            {{ date(getDateFormat(), strtotime($branchadmin->birth_date)) }}
            @else
          ...
          <div class="guardian_div mb-3">
            <div class="row">
              ...
              <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                ...
                <label class="fw-bold">
                  {{ $branchadmin->landline_no ?? trans('message.Not Added') }}
                </label>
              </div>
              <div class="col-xl-12 col-md-12 col-sm-12 mt-1">
                <label class=""> {{ trans('message.Branch') }} : </label>
                <label class="fw-bold">
                  {{ getBranchName($branchadmin->branch_id) }}
                </label>
              </div>
          ...
          <div class="guardian_div mb-1">
            ...
            <div class="row">
              ...
              <!-- <div class="col-xl-6 col-md-6 col-sm-12 mt-1">
                ...
                <label class="text-dark fw-bold">{{ $branchadmin->address }}</label>
              </div> -->
            </div>
