      ...
      <div class="nav_menu">
        <nav>
          <div class="nav toggle">
            <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{!! url('/income/list') !!}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow"></i><span class="titleup">
        ...
        <div class="x_content">
          <form method="post" id="addIncomeForm" action="{{ url('/income/store') }}" enctype="multipart/form-data" class="form-horizontal upperform addIncomeForm" id="add-income-form">
            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
              <h4><b>{{ trans('message.INCOME DETAILS') }}</b>
              </h4>
            ...
            <div class="row form-group row-mb-0">
              <div class="row col-md-6 col-sm-6 col-xs-12 form-group my-form-group">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 padding-right-7">
            ...
            <div class="items row row-mb-0">
              <div class="row form-group padding-left-0">
            ...
            <div class="row">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 my-1 mx-0 pl-22 pr-50">
