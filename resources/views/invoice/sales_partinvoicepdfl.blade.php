        ...
        <tr>
          ...
          <td style="width: 40%; vertical-align:top;" class="invoice_detail">
            <span style="float:right;">
              ...
              <br>
              @if(($invioce->details) != '')
              <b>{{ trans('message.Details') }} :</b> <?php echo $invioce->details; ?>
              @endif
            </span>
          </td>
        </tr>
      ...
      <tbody>
        ...
        <tr>
          <td valign="top" style="font-size: 14px;" width="55%" align="left">
            <b><img src="{{ base_path() }}/public/img/icons/Vector (14).png" class=" mail_img"></b>
            <?php echo getCustomerAddress($salespart->customer_id);
            echo ', '; ?> <?php echo getCustomerCity($salespart->customer_id) != null ? getCustomerCity("$salespart->customer_id") . ',' : ''; ?><?php echo getCustomerState("$salespart->customer_id,");
                                                                                                                                                    echo ', ';
                                                                                                                                                    echo getCustomerCountry($salespart->customer_id); ?>
          </td>
          <td align="top" style="font-size: 14px;" width="23%" align="left">
            <b><img src="{{ base_path() }}/public/img/icons/user_img.png" class="user_img"></b> <?php echo getCustomerName($salespart->customer_id); ?><br>
            <b><img src="{{ base_path() }}/public/img/icons/phoneimg1.png" class="phoneimg"></b> <?php echo getCustomerMobile($salespart->customer_id); ?> <br>
            <b><img src="{{ base_path() }}/public/img/icons/Vector (15).png" class=" mail_img"></b> <?php echo getCustomerEmail($salespart->customer_id); ?><br>
