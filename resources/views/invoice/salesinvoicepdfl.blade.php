          ...
          <tr class="system_addr">
            <td width="50%" style="vertical-align:top;float:left;" align="left">
              <span style="float:left;">
                <img src="{{ base_path() }}/public/img/icons/phoneimg1 (15).png" class="mail_img">
                <?php
                echo ' ' . $logo->email;
                ?>
                <br>
        ...
        <tbody class=" invoicepdf">
          ...
          <tr>
            ...
            <td valign="top" width="30%" align="left">
              ...
              <b><img src="{{ base_path() }}/public/img/icons/phoneimg1.png" class="phoneimg"> </b> <?php echo getCustomerMobile($sales->customer_id); ?> <br>
              <b><img src="{{ base_path() }}/public/img/icons/Vector (15).png" class=" mail_img"> </b> <?php echo getCustomerEmail($sales->customer_id); ?>
              <br>
