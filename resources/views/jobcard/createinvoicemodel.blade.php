        ...
        <div id="form_fields">
          ...
          <div class="row mt-3">
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6" id="job" style="">
              <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 p-0 mt-2" for="job_card">{{ trans('message.Jobcard Number') }} <label class="color-danger">*</label></label>
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
          ...
          <div class="row mt-3">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6  paymentTypeMainDiv">
              <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 p-0 ps-2 mt-2" for="cus_name">{{ trans('message.Payment Type') }} <label class="color-danger">*</label></label>
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                <div class="select-wrapper">
