...
?>
                    ...
                    <div class="nav_menu">
                        <nav>
                            <div class="nav toggle titleup">
                                <span class="">&nbsp
                                    {{ trans('message.You are not authorize this page.') }}</span>
                            </div>
                        </nav>
                    </div>
                </div>
        ...
        @else
            <div class="right_col" role="main">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_content">
                            <ul class="nav nav-tabs bar_tabs tabconatent" role="tablist">
                                ...
                                <li role="presentation" class="active" style="margin-left: 8px;"><a
                                        href="{!! url('/jobcard/list/' . $services->id) !!}" class="process"><span class="visible-xs"></span><i
                                            class="fa fa-plus-circle fa-lg i">&nbsp;</i><b>{{ trans('message.fsfsfProcess JobCard') }}</b></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="well well-sm titleup">{{ trans('message.Processing Job for...') . $services->job_no }}
                            </div>
                            <form method="post" action="{!! url('/jobcard/store') !!}">
                                ...
                                <div class="col-md-12 col-xs-12 col-xs-12">
                                        ...
                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                            <div class="col-md-5 col-xs-12 col-sm-12 printimg">
                                                <img src="{{ url('/public/general_setting/' . $logo->logo_image) }}"
                                                    width="200" height="70px" style="max-height: 80px;">
                                            </div>
                                    ...
                                    <div class="col-md-5 col-xs-12 col-sm-12">
                                        <div class="col-md-12 col-xs-12 col-sm-12">
                                            <label
                                                class="control-label jobcardmargintop col-md-4 col-sm-12 col-xs-12">{{ trans('message.Job Card No') }}
                                                <label class="text-danger">*</label></label>
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                <input type="text" id="job_no" name="job_no"
                                                    value="{{ $services->job_no }}" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px;">
                                            <label
                                                class="control-label jobcardmargintop col-md-4 col-sm-12 col-xs-12">{{ trans('message.In Date/Time') }}
                                                <label class="text-danger">*</label></label>
                                        ...
                                        <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px;">
                                            <label
                                                class="control-label jobcardmargintop col-md-4 col-sm-12 col-xs-12 ">{{ trans('message.Out Date/Time') }}
                                            </label>
                                            <div class="col-md-8 col-sm-12 col-xs-12 input-group date">
                                                <span class="input-group-addon"><i
                                                        class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                                                ...
                                                <input type="text" id="out_date" name="out_date"
                                                    value="<?php echo date(getDateFormat() . ' H:i:s', strtotime($job->out_date)); ?>" class="form-control"
                                ...
                                <div class="col-md-12 col-xs-12 col-xs-12">
                                    <div class="col-md-4 col-xs-12 col-sm-12">
                                        <h2 class="text-left jobcard_heading">{{ trans('message.Customer Details') }}</h2>
                                        <p class="col-md-12 col-xs-12 col-sm-12 space1_solid"></p>
                                        <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px;">
                                            <label
                                                class="control-label jobcardmargintop col-md-3 col-sm-3 col-xs-12">{{ trans('message.Name') }}
                                                :</label>
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                <input type="text" id="name" name="name" class="form-control"
                                                    value="{{ getCustomerName($services->customer_id) }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:5px;">
                                            <label
                                                class="control-label jobcardmargintop col-md-3 col-sm-3 col-xs-12">{{ trans('message.Address') }}
                                                :</label>
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                <input type="text" id="address" name="address" class="form-control"
                                                    value="{{ getCustomerAddress($services->customer_id) }}" readonly>
                                            </div>
                                        </div>

                                        <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:8px;">
                                            <label
                                                class="control-label col-md-3 col-sm-3 col-xs-12">{{ trans('message.Contact No') }}
                                                :</label>
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                <input type="text" id="con_no" name="con_no" class="form-control"
                                                    value="{{ getCustomerMobile($services->customer_id) }}" readonly>
                                            </div>
                                        </div>

                                        <div class="col-md-12 col-xs-12 col-sm-12" style="margin-top:8px;">
                                            <label class="control-label jobcardmargintop col-md-3 col-sm-3 col-xs-12">
                                                {{ trans('message.Email') }} :</label>
                                            <div class="col-md-8 col-sm-12 col-xs-12">
                                                <input type="text" id="email" name="email" class="form-control"
                                                    value="{{ getCustomerEmail($services->customer_id) }}" readonly>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-md-8 col-sm-12 col-xs-12 vehicle_space">
                                        <h2 class="text-left jobcard_heading">{{ trans('message.Vehicle Details') }}</h2>
                                        <p class="col-md-12 col-xs-12 col-sm-12 space1_solid"></p>
                                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-12"
                                                style="padding-top: 7px;">{{ trans('message.Model Name') }} :</label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" id="model" name="model" class="form-control"
                                                    value="{{ $vehicale->modelname }}" readonly>
                                            </div>

                                            <label
                                                class="jobcardmargintop col-md-2 col-sm-2 col-xs-12">{{ trans('message.Chasis No') }}
                                                :
                                            </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" id="coupan_no" name="coupan_no"
                                                    class="form-control" value="{{ $vehicale->chassisno }}" readonly>
                                            </div>
                                        </div>

                                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                                            <label
                                                class="jobcardmargintop control-label col-md-2 col-sm-2 col-xs-12">{{ trans('message.Engine No') }}:
                                            </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 divId" id="divId"
                                            ...
                                            <label
                                                class="control-label col-md-2 col-sm-2 col-xs-12">{{ trans('message.Date Of Sale') }}
                                                :
                                            </label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <input type="text" id="sales_date" name="sales_date"
                                                    class="form-control"
                                                    value="{{ date('d/m/Y', strtotime($s_date->date)) }}" readonly>
                                            </div>

                                            <label
                                                class="jobcardmargintop col-md-2 col-sm-2 col-xs-12">{{ trans('message.Color') }}
                                                :</label>
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        @if (!empty($job->coupan_no))
                                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top:5px;">
                                                ...
                                                <label
                                                    class="col-md-2 col-sm-2 col-xs-12">{{ trans('message.Free Service Coupan No') }}
                                                    :</label>
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-2 col-sm-4 col-xs-4" style="padding-top:8px;">
                                        <button type="button" data-target="#responsive-modal-observation"
                                            data-toggle="modal"
                                            class="btn btn-default">{{ trans('message.Add New') }}</button>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title tbl_points">
                                                <a data-toggle="collapse" href="#collapse1" style="color:#5A738E"><i
                                        ...
                                        <div id="collapse1" class="panel-collapse collapse">
                                            <div class="panel-body ">
                                                <table class="table  table-striped dataTable table-bordered main_data"
                                                    id="main_data_points" align="center">
                                ...
                                <div class="form-group" style="margin-top:30px;">
                                    <h2 style="margin-left:10px;">{{ trans('message.Other Service Charges') }}</h2>
                                </div>
                                <hr>
                                <button type="button" id="add_new_product" class="btn btn-default"
                                    url="{!! url('/jobcard/addproducts') !!}" style="margin:5px 0px;">{{ trans('message.Add New') }}
                                </button>
                                <div class="form-group" style="margin-top:20px;">
                                    <table class="table table-bordered addtaxtype" id="tab_products_detail"
                                        align="center">
                                        <thead>
                                            <tr>
                                            ...
                                            @if (!empty($pros))
                                                ...
                                                @foreach ($pros as $product)
                                                    <tr id="<?php echo 'row_id_' . $id; ?>">
                                                        <td>
                                                            <input type="text" name="other_product[]"
                                                                class="form-control" value="<?php echo $product->comment; ?>"
                                                                id="othr_prod_<?php echo $id; ?>"
                                                                othr_prod="<?php echo $product->id; ?>">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="other_price[]"
                                                                class="form-control" id="oth_price"
                                                                value="<?php echo $product->total_price; ?>">
                                                        </td>
                                                        <td>
                                                            <span class="trash_product" style="cursor: pointer;"
                                                                data-id="<?php echo $id; ?>"
                                                                oth_url="<?php echo url('jobcard/oth_pro_delete'); ?>"><i
                                                                    class="fa fa-trash fa-2x"
                                                                    style="vertical-align: middle !important;"></i></span>
                                                        </td>
                                                    </tr>
                                                    <?php $id++; ?>
                                                @endforeach
                                ...
                                <div class="col-md-12">
                                    <div id="responsive-modal-observation" class="modal fade" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                                ...
                                                                <div class="panel-heading">
                                                                    <h4 class="panel-title">
                                                                        <a data-toggle="collapse"
                                                                            href="#collapse1-{{ $checkoout->id }}"><i
                                                                                class="glyphicon glyphicon-plus"></i>{{ $checkoout->checkout_point }}</a>
                                                                    ...
                                                                    <div class="panel-body">
                                                                        <table class="table table-striped">
                                                                            <thead>
                                                                                <tr>
                                                                                    <td><b>#</b></td>
                                                                                    <td><b>{{ trans('message.Checkpoints') }}</b>
                                                                                    </td>
                                                                                    <td><b>{{ trans('message.Choose') }}</b>
                                                                                    </td>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                                ...
                                                                                <tr
                                                                                    ...
                                                                                    <td>
                                                                                        <?php echo $i++; ?></td>
                                                                                    <td
                                                                                        class="row{{ $subcategorys->checkout_point }}">
                                                                                    ...
                                                                                    <td>
                                                                                        <input type="checkbox"
                                                                                            <?php echo $data; ?>
                                                                                            name="chek_sub_points"
                                                                                            name="check_sub_points[]"
                                                                                            check_id="{{ $subcategorys->id }}"
                                                                                            class="check_pt"
                                                                                            url="{!! url('jobcard/select_checkpt') !!}"
                                                                                            s_id="{{ getServiceId($services->id) }}"
                                                                                            sale_id="{{ $services->id }}"
                                                                                            sub_pt="{{ $subcategorys->checkout_point }}"
                                                                                            main_cat="{{ $checkoout->checkout_point }}">
                                                                                    </td>
                                                                                </tr>
                                                                                <?php }
																					}
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button"
                                                        class="btn btn-success col-md-offset-10 check_submit"
                                                        style="margin-bottom:5px;">{{ trans('message.Submit') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <button type="submit" class="btn btn-success col-md-offset-10"
                                    style="margin-bottom:10px;">{{ trans('message.Submit') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $('.deletedatas').click(function() {
            ...
            var msg3 = "{{ trans('message.Yes, delete!') }}"
            swal({
                title: msg1,
                text: msg2,
