          ...
          <nav>
            <div class="nav toggle">
              <a id="menu_toggle"><i class="fa fa-bars"></i><span class="titleup">&nbsp;
                  {{ trans('message.Observation Point') }}</span></a>
            </div>
          ...
          <div class="x_content">
            <ul class="nav nav-tabs bar_tabs"
              ...
              <li role="presentation"
                class="active"><a href="{!! url('/observation_point/list') !!}"><span class="visible-xs"></span><i
                    class="fa fa-list fa-lg">&nbsp;</i><b>{{ trans('message.List Of Observation Point') }}</b></span></a>
              </li>

              <li role="presentation"
                class=""><a href="{!! url('/observation_point/add') !!}"><span class="visible-xs"></span><i
                    class="fa fa-plus-circle fa-lg">&nbsp;</i>{{ trans('message.Add Observation Point') }}</span></a></li>
            </ul>
          </div>
                ...
                @foreach ($tbl_observation_points as $tbl_observation_point)
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{!! url('/observation_point/list/edit/' . $tbl_observation_point->id) !!}"><button type="button"
                          class="btn btn-round btn-success">{{ trans('message.Edit') }}</button></a>
                      <a url="{!! url('/observation_point/list/delete/' . $tbl_observation_point->id) !!}"
                        class="deletedatas"><button type="button"
