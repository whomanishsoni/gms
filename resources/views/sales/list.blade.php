                ...
                <nav>
                    <div class="nav toggle">
                        ...
                        <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><span class="titleup">{{ trans('message.Vehicle Sells') }}
                            @can('sales_add')
                            <a href="{!! url('/sales/add') !!}" id="" class="addbotton">
                                    ...
                                    <div class="dropdown_toggle">
                                        ...
                                        <ul class="dropdown-menu heder-dropdown-menu action_dropdown shadow py-2" aria-labelledby="dropdownMenuButtonaction">
                                            ...
                                            <li>@can('sales_delete')
                                                ...
                                                <a url="{!! url('sales/list/delete/' . $sale->id) !!}" class="dropdown-item deletedatas" style="color:#FD726A"><img src="{{ URL::asset('public/img/list/Delete.png') }}" class="me-3">{{ trans('message.Delete') }}</button></a>
                                                @endcan
                                            </li>
                                            @else
                                            ...
                                            <li>
                                                @can('sales_delete')
                                                <div class="dropdown-divider m-0"></div>
                                                <a url="{!! url('sales/list/delete/' . $sale->id) !!}" class="deletedatas"><button type="button" class="btn btn-round btn-danger">{{ trans('message.Delete') }}</button></a>
                                                @endcan
                                                @endif
                                            </li>
                                        </ul>
