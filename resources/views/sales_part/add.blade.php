                                    ...
                                    <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                                        <select class="form-control customer_select form-select" id="customer_select_box1" name="cus_name">
                                            ...
                                            <option value="{{ $customers->id }}">
                                                {{ $customers->name . ' ' . $customers->lastname }}-{{$customers->mobile_no}}
                                            </option>
                                            @endforeach
                                            @endif
                                        </select>
...
<script>
    ...
    $('body').on('keyup', '.qty', function() {
        ...
        var url = $(this).attr('prd_url');  // Add the url for checking stock
 ...
 //start ajax for check Available stock
    ...
    //     }
    // });
 //end check Available stock
  //Updated enter user input in stock quantity input
    ...
    // Debounce to avoid multiple requests as user types quickly
    ...
    }, 500)); // Delay the request by 500ms to reduce frequent AJAX calls
});

// Allow numeric input via keyboard
$('body').on('keydown', '.qty', function(e) {
    var keyCode = e.keyCode || e.which;

    // Allow only numeric values, backspace, and arrow keys
    if (!(keyCode >= 48 && keyCode <= 57 || keyCode >= 96 && keyCode <= 105 || keyCode === 8 || keyCode === 46 || keyCode === 38 || keyCode === 40)) {
        e.preventDefault();
    }
...
//done user input in stock Quantity
