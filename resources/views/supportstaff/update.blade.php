    ...
    <div class="page-title">
      <div class="nav_menu">
        <nav>
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{{ URL::previous() }}" id=""><i class=""><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow"></i><span class="titleup" style="margin-right: 5px;"> {{ trans('message.Edit Supportstaff') }}</span>
            </a>
          </div>
          ...
          <form id="supportstaff_edit_form" action="update/{{ $supportstaff->id }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left input_mask">
            ...
            <div class="row row-mb-0">
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback {{ $errors->has('firstname') ? ' has-error' : '' }}">
                <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="firstname">{{ trans('message.First Name') }} <label class="text-danger">*</label></label>

                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" id="firstname" name="firstname" placeholder="{{ trans('message.Enter First Name') }}" value="{{ $supportstaff->name }}" class="form-control" maxlength="50">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback {{ $errors->has('lastname') ? ' has-error' : '' }}">
                <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-12 col-xs-4" for="lastname">{{ trans('message.Last Name') }} <label class="text-danger">*</label></label>

                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" id="lastname" name="lastname" placeholder="{{ trans('message.Enter Last Name') }}" maxlength="50" value="{{ $supportstaff->lastname }}" class="form-control">
                </div>
              </div>
            </div>
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8 gender ps-0">
                  ...
                  <input type="radio" name="gender" value="0" <?php if ((int)$supportstaff->gender === 0) {
                                                                echo 'checked';
                                                              } ?>>
                  {{ trans('message.Male') }}

                  <input type="radio" name="gender" value="1" <?php if ((int)$supportstaff->gender === 1) {
                                                                echo 'checked';
                                                              } ?>>
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback {{ $errors->has('displayname') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" name="displayname" id="displayname" placeholder="{{ trans('message.Enter Display Name') }}" value="{{ $supportstaff->display_name }}" maxlength="25" class="form-control ">
                </div>
              </div>
            </div>
            <div class="row row-mb-0">
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback {{ $errors->has('landlineno') ? ' has-error' : '' }} custom-margin">
                <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="landlineno">{{ trans('message.Landline No.') }} <label class="text-danger"></label>
                </label>
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" id="landlineno" name="landlineno" placeholder="{{ trans('message.Enter LandLine No') }}" value="{{ $supportstaff->landline_no }}" maxlength="16" minlength="6" class="form-control">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 has-feedback {{ $errors->has('image') ? ' has-error' : '' }}">
                <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="">{{ trans('message.Image') }} </label>
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="file" id="image" name="image" class="form-control chooseImage">
                  <img src="{{ url('public/supportstaff/' . $supportstaff->image) }}" width="52px" height="52px" id="imagePreview" class="datatable_img mt-2">
                  @if ($errors->has('image'))
                  <span class="help-block">
