    ...
    <div class="page-title">
      <div class="nav_menu">
        <nav>
          ...
          <a href="{!! url('/vehiclebrand/list') !!}" id=""><span class="titleup"><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow">
              ...
              <div class="row row-mb-0">
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                  <select name="vehicaltypes" class="form-control col-md-7 col-xs-12 form-select">
                    ...
                    <option value="{{ $vehicaltypess->id }}" <?php if ($vehicaltypess->id == $vehicalbrands->vehicle_type_id) {
                                                                echo 'selected';
