    ...
    <div class="page-title">
      <div class="nav_menu">
        <nav>
          ...
          <a id="menu_toggle"><i class="fa fa-bars sidemenu_toggle"></i></a><a href="{!! url('/vehicletype/list') !!}" id=""><span class="titleup"><img src="{{ URL::asset('public/supplier/Back Arrow.png') }}" class="back-arrow">
                {{ trans('message.Edit Vehicle Type') }}</span></a>
          </div>
          ...
          <div class="x_panel">
            <form id="vehicleTypeEdit-Form" action="update/{{ $vehicaltypes->id }}" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="row row-mb-0">
                <label class="control-label checkpointtext text-end col-md-2 col-lg-2 col-xl-2 col-xxl-2 col-sm-2 col-xs-2" for="first-name">{{ trans('message.Vehicle Type') }} <label class="color-danger">*</label>
                </label>
              ...
              <div class="row">
                ...
                <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 my-2 mx-0">
                  <button type="submit" class="btn btn-success updateVehicleTypeButton">{{ trans('message.UPDATE') }}</button>
                </div>
              </div>
...
<script>
  ...
  $('body').on('click', '.updateVehicleTypeButton', function(e) {
    $('#vehicleTypeEdit-Form input, #vehicleTypeEdit-Form select, #vehicleTypeEdit-Form textarea').each(

      function(index) {
        var input = $(this);

        if (input.attr('name') == "p_date" || input.attr('name') == "name" || input.attr('name') == "price" ||
          input.attr('name') == "unit" || input.attr('name') == "sup_id") {
          if (input.val() == "") {
            return true;
          } else {
            return true;
